...
class ClassifyTriangleTests(unittest.TestCase):
    ...
    def test_T1_1(self):
        ...
        self.assertEquals(triangle_object.message, 'ERROR:All values must be greater than zero')
    ...
    def test_T2_1(self):
        ...
        self.assertEquals(triangle_object.message, 'ERROR:All values must be less than 1000')
